...
<body>
   ...
   <div class="signup-container">
      ...
      <form action="#" method="POST">
         ...
         <div class="form-main">
            <div class="names">
               <input type="text" id="first-name" name="first-name" value="<?php if ($havePost && $errors != '')  ?>"
                  placeholder="First Name"><input type="text" id="last-name" name="last-name"
                  value="<?php if ($havePost && $errors != '')  ?>" placeholder="Last Name">
            </div>
            <br>

            <input type="text" id="dob" name="dob" value="<?php if ($havePost && $errors != '') {
                                                               echo $dob;
                                                            } ?>" placeholder="Date of Birth (YYYY-MM-DD)"><br><br>

            <input type="text" id="major" name="major" value="<?php if ($havePost && $errors != '') {
                                                                  echo $major;
                                                               } ?>" placeholder="Major"><br><br>

            <input type="email" id="email" name="email" value="<?php if ($havePost && $errors != '') {
                                                                  echo $email;
                                                               } ?>" placeholder="Email"><br><br>

            <input type="password" id="password" name="password" value="<?php if ($havePost && $errors != '') {
                           echo $password;
