document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderSelectedItems() {
        ...
        if (selectedItems.size === 0) {
            ...
            selectedValue.textContent = `${selectedItems.size} item${selectedItems.size === 1 ? '' : 's'} selected`;
        }
    ...
    const preSelectedOptions = document.querySelectorAll('#originalSelect option[selected]');
