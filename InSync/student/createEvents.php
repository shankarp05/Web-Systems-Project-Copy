...
<head>
    ...
    <title>Create Event - InSync</title>
    <!-- <link rel="stylesheet" href="resources/home.css" /> -->
    <link rel="stylesheet" href="resources/event.css" />
        ...
        <div class="formSectionWrapper">
            ...
            <form class = "formSection" id="event-form" action="#" method="POST">
                <div class="form-item">
                    ...
                    <label for="eventEmails">Invite Users (Emails):</label><br>
                    <textarea id="eventEmails" name="eventEmails" placeholder="Enter email addresses, separated by commas"></textarea><br><br>

                    <label for="eventDescription">Event Description:</label><br>
                    <textarea id="eventDescription" name="eventDescription" rows="4" cols="30" required></textarea><br><br>
                    <label>Tags: </label>
